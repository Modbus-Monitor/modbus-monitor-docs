...
# Auto-generated from tracker (2026-06-30)
    TargetSpec("Eaton", "eaton", "IQ100 series,IQ130,IQ140,IQ150", "iq100-series-iq130-iq140-iq150", "Power Meter", 1, ("IQ100 series,IQ130,IQ140,IQ150")),
    TargetSpec("Eaton", "eaton", "Power Xpert Meter,PXM 1000", "power-xpert-meter-pxm-1000", "Power Meter", 1, ("Power Xpert Meter,PXM 1000")),
    TargetSpec("Electro Industries", "electro-industries", "Shark 200", "shark-200", "Power Meter", 1, ("Shark 200")),
    TargetSpec("Phoenix Contact", "phoenix-contact", "EEM-EM3xx,EM325,EM355,EM375,EM327,EM357,EM377", "eem-em3xx-em325-em355-em375-em327-em357-em377", "Power Meter", 1, ("EEM-EM3xx,EM325,EM355,EM375,EM327,EM357,EM377")),
    TargetSpec("Phoenix Contact", "phoenix-contact", "EEM-MA,EEM-MA3xx", "eem-ma-eem-ma3xx", "Power Meter", 1, ("EEM-MA,EEM-MA3xx")),
    TargetSpec("Phoenix Contact", "phoenix-contact", "EEM-MA3xx", "eem-ma3xx", "Power Meter", 1, ("EEM-MA3xx")),
    TargetSpec("Eaton Power Meter", "eaton-power-meter", "IQ250, IQ260", "iq250-iq260", "Power Meter", 1, ("IQ250", "IQ260"), True),
    TargetSpec("SMA", "sma", "Solar Inverter", "solar-inverter", "Power Meter", 1, ("Solar Inverter")),
    TargetSpec("Socomec", "socomec", "DIRIS,D30,D50,D70", "diris-d30-d50-d70", "Power Meter", 1, ("DIRIS,D30,D50,D70")),
    TargetSpec("Socomec", "socomec", "DIRIS,D30,D50,D70 _", "diris-d30-d50-d70", "Power Meter", 1, ("DIRIS,D30,D50,D70 _")),
    TargetSpec("Socomec", "socomec", "Countis E63", "countis-e63", "Power Meter", 1, ("Countis E63")),
    TargetSpec("Socomec", "socomec", "Countis E33, Countis E43", "countis-e33-countis-e43", "Power Meter", 1, ("Countis E33", "Countis E43"), True),
    TargetSpec("Socomec", "socomec", "Countis E34, Countis E44", "countis-e34-countis-e44", "Power Meter", 1, ("Countis E34", "Countis E44"), True),
    TargetSpec("Socomec", "socomec", "NETYS PR,NETYS RT,ITYS", "netys-pr-netys-rt-itys", "UPS", 1, ("NETYS PR,NETYS RT,ITYS")),
    TargetSpec("Socomec", "socomec", "Multis L20, Multis L40", "multis-l20-multis-l40", "Power Meter", 1, ("Multis L20", "Multis L40"), True),
    TargetSpec("Socomec", "socomec", "Countis E23", "countis-e23", "Power Meter", 1, ("Countis E23")),
    TargetSpec("Socomec", "socomec", "Countis E24", "countis-e24", "Power Meter", 1, ("Countis E24")),
    TargetSpec("Fronius Inverter", "fronius-inverter", "110,111.112,113", "110-111-112-113", "Power Meter", 1, ("110,111.112,113")),
    TargetSpec("Socomec", "socomec", "Countis E50 E53 E50R E53R", "countis-e50-e53-e50r-e53r", "Power Meter", 1, ("Countis E50 E53 E50R E53R")),
    TargetSpec("Electro Industries", "electro-industries", "Shark 50", "shark-50", "Power Meter", 1, ("Shark 50")),
    TargetSpec("Janitza", "janitza", "ECS", "ecs", "Power Meter", 1, ("ECS")),
    TargetSpec("Socomec", "socomec", "DIRIS A20 modbus", "diris-a20-modbus", "Power Meter", 1, ("DIRIS A20 modbus")),
    TargetSpec("Socomec", "socomec", "Countis E13", "countis-e13", "Power Meter", 1, ("Countis E13")),
    TargetSpec("Socomec", "socomec", "Countis E14", "countis-e14", "Power Meter", 1, ("Countis E14")),
    TargetSpec("Huawei", "huawei", "Solar Inverter", "solar-inverter", "Power Meter", 1, ("Solar Inverter")),
    TargetSpec("Janitza", "janitza", "UMG511", "umg511", "Power Meter", 1, ("UMG511")),
    TargetSpec("Fronius Power Meter", "fronius-power-meter", "210,211.212,213", "210-211-212-213", "Power Meter", 1, ("210,211.212,213")),
    TargetSpec("Janitza", "janitza", "B21,B23,B24", "b21-b23-b24", "Power Meter", 1, ("B21,B23,B24")),
    TargetSpec("Socomec", "socomec", "Masterys", "masterys", "UPS", 1, ("Masterys")),
    TargetSpec("Huawei", "huawei", "Sun2000 -env", "sun2000-env", "Solar Inverter", 1, ("Sun2000 -env")),
    TargetSpec("Socomec", "socomec", "Countis E03", "countis-e03", "Power Meter", 1, ("Countis E03")),
    TargetSpec("Socomec", "socomec", "Countis E04", "countis-e04", "Power Meter", 1, ("Countis E04")),
    TargetSpec("Fronius Inverter", "fronius-inverter", "Common", "common", "Power Meter", 1, ("Common")),
    TargetSpec("Socomec", "socomec", "DIRIS U20", "diris-u20", "Power Meter", 1, ("DIRIS U20")),
    TargetSpec("Socomec", "socomec", "DIRIS U10", "diris-u10", "Power Meter", 1, ("DIRIS U10")),
)
