...
### Modbus Monitor XPF v5.0.3.0

**Release Date:** March 9, 2026  
**Status:** Latest Stable

[:octicons-download-24: Download v5.0.3.0](https://github.com/Modbus-Monitor/modbus-monitor-docs/releases/download/v5.0.3.0/Modbus-Monitor-XPF-5.0.3.0-x64-setup.exe){ .md-button .md-button--primary }

[Release Notes](../releases/v5.0.3.0.md){ .md-button } [Microsoft Store](https://www.microsoft.com/store/apps/9PG862WL5HSM){ .md-button }
...
|---------|------|--------|---|
| v5.0.3.0 | 2026-03-09 | Latest | [Download](https://github.com/Modbus-Monitor/modbus-monitor-docs/releases/tag/v5.0.3.0){ .md-button .md-button--primary } |
