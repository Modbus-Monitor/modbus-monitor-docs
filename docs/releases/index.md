...
[:octicons-download-24: Download v5.0.4.2](https://github.com/Modbus-Monitor/modbus-monitor-docs/releases/download/v5.0.4.2/Modbus-Monitor-XPF-5.0.4.2-x64-setup.exe){ .md-button .md-button--primary }

[Release Notes](../releases/v5.0.4.2.md){ .md-button } [Microsoft Store](https://www.microsoft.com/store/apps/9PG862WL5HSM){ .md-button }
...
|---------|------|--------|---|
| v5.0.4.2 | 2026-05-02 | Latest | [Download](https://github.com/Modbus-Monitor/modbus-monitor-docs/releases/tag/v5.0.4.2){ .md-button .md-button--primary } |
