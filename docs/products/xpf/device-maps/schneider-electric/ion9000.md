...
description: Schneider Electric ION9000 Modbus map with register preview, power meter overview, common data categories, and ready-to-use setup guidance for Modbus Monitor XPF.
---
...
For Schneider Electric ION9000 deployments, teams often use this map to surface current, voltage, and power data in data centers, switchgear lineups, and advanced power monitoring projects.
