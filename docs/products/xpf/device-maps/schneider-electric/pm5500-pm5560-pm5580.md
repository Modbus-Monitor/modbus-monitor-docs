...
description: Schneider Electric PM5500 / PM5560 / PM5580 Modbus map with register preview, power meter overview, common data categories, and ready-to-use setup guidance for Modbus Monitor XPF.
---
...
For Schneider Electric PM5500 / PM5560 / PM5580 deployments, teams often use this map to surface voltage, current, and power data in data centers, switchgear lineups, and advanced power monitoring projects.
