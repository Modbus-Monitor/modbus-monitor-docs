...
description: Pre-built Eaton PXM2000 Modbus map for Modbus Monitor XPF with register preview, device overview, and setup guidance.
---

# Eaton PXM2000 Modbus Map

Use this pre-built Eaton PXM2000 Modbus map in Modbus Monitor XPF to reduce setup time and start monitoring faster. This page provides a technical preview of the supported power meter map, common data categories, and typical use cases.
